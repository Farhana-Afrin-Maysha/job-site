    ...
    <div>
        ...
        <div class="container">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="education" class="col-sm-3 control-label">Educational Qualification</label>
                        <div class="col-sm-9">
                            <input type="text" id="education" placeholder="Educational Qualification" class="form-control" autofocus required>
                        </div>
                    </div>
                    <div class="form-group">
